...
export function BoutiqueSectionShell({ children }: BoutiqueSectionShellProps) {
  return (
    <div className="relative flex flex-1 flex-col">
      ...
      />
      <main className="relative mx-auto flex w-full max-w-lg flex-1 flex-col gap-6 overflow-x-hidden px-4 pb-8 pt-6 sm:max-w-2xl sm:px-5 md:max-w-4xl lg:max-w-6xl">
        {children}
      </main>
    </div>
  );
